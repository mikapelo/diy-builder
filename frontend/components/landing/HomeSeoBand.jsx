...
const PROJECTS = [
  {
    ...
    desc: "Lames, lambourdes, plots béton : le calculateur applique l'entraxe DTU 51.4 (40-50 cm selon section), génère votre nomenclature exportée en PDF et compare les 4 enseignes principales. Pour une terrasse 4×3 m, comptez 500 à 640 € de matériaux en pin classe 4 selon l'enseigne.",
    simHref: '/calculateur',
  ...
  },
  {
    ...
    desc: "Montants 45×90 mm à entraxe 60 cm (DTU 31.2), coins en L, montants d'encadrement de porte et fenêtre, linteaux, chevrons mono-pente : le simulateur calcule l'ossature complète et le bardage. Budget typique : 1 400 à 3 400 € selon la surface.",
    simHref: '/cabanon',
