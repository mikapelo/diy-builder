...
/**
 * ArtisanLeadModal.jsx — Modale mise en relation artisan
 *
 ...
 *   bom         — object  (non utilisé pour l'instant)
 *   initialEmail — string (non utilisé pour l'instant)
 */
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Mise en relation artisan — bientôt disponible"
      ...
      >
        ...
        <div className="modal-header">
          ...
          <p className="modal-subtitle">
            Le service de mise en relation avec un artisan sera disponible prochainement.
          </p>
        </div>

        <p style={{ padding: '0 0 16px', fontSize: 14, lineHeight: 1.6, color: 'var(--color-text-secondary, #555)' }}>
          En attendant, télécharge ton devis PDF et utilise-le pour faire chiffrer
          ton projet directement par les pros de ta région.
        </p>
