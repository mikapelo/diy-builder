...
const FALLBACK_ICON = { pergola: 'pergola', terrasse: 'deck', cloture: 'fence', carport: 'solar_power', 'cloture-solaire': 'solar_power', 'terrasse-composite': 'deck', 'abri-metal': 'cottage', 'dalle-clipsable': 'grid_view', 'tonnelle': 'gazebo' };
