...
export const MATERIAL_PRICES = [
  ...
  // LM : Bastaing (solive) sapin traité 50×150mm 4m = 19,90€ → 4,98€/ml (scraping direct Chrome 2026-06-22 ; précédent 5,63)
  ...
  // LM : 19,90€ "Poteau bois carré naturel Classe 4, l.9 x P.9 x H.240cm" (Chrome 2026-06-22 ; précédent 19,50€)
  ...
  { id: 'poteau_cloture_90',       label: 'Poteau clôture 90×90 mm (2,4 m)',       section: '90×90',    unit: 'pcs', refLen: 2.4, scraped: true, prices: { leroymerlin: 19.9, castorama: 17.9, bricodepot: 18.9, manomano: 16.97 } },
