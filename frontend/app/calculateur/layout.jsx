...
const OG_URL = `https://diy-builder.fr/api/og?title=${encodeURIComponent(OG_TITLE)}&subtitle=${encodeURIComponent(OG_SUBTITLE)}&type=simulateur&icon=terrasse`;
...
export const metadata = {
  ...
  alternates: { canonical: 'https://diy-builder.fr/calculateur' },
  openGraph: {
