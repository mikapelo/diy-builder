...
export default function CalculateurPage() {
  ...
  return (
    <div className="min-h-screen" data-theme="g-v2" style={{ background: 'var(--surface)' }}>
      <JsonLd data={HOW_TO_SCHEMAS.terrasse} />
      <JsonLd data={JSON.parse('{"@context": "https://schema.org", "@type": "SoftwareApplication", "name": "Calculateur terrasse bois gratuit", "description": "Calculez gratuitement les matériaux et le coût de votre terrasse bois. Visualisation 3D, liste de matériaux et comparatif des enseignes inclus.", "url": "https://www.diy-builder.fr/calculateur", "applicationCategory": "UtilitiesApplication", "operatingSystem": "Web", "offers": {"@type": "Offer", "price": "0", "priceCurrency": "EUR"}, "keywords": "calculateur terrasse bois, devis terrasse bois, matériaux terrasse bois", "inLanguage": "fr-FR", "author": {"@type": "Organization", "name": "DIY Builder", "url": "https://www.diy-builder.fr"}}')} />
      <Header
        view="module"
        resultat={true}
        copied={copied}
