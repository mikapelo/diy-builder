...
const OG_URL = `https://www.diy-builder.fr/api/og?title=${encodeURIComponent(OG_TITLE)}&subtitle=${encodeURIComponent(OG_SUBTITLE)}&type=guide&icon=dalle`;
...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.diy-builder.fr/guides/dalle' },
  openGraph: {
