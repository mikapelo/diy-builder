      ...
      <div className="content-container">
        ...
        <aside className="content-related">
          ...
          <ul>
            ...
            <li><Link href="/guides/brise-vue-quel-type-choisir">Brise-vue : le piège de l&apos;occultant rapporté</Link> — rehausser une clôture déjà conforme peut créer une infraction : le cas particulier de l&apos;occultation</li>
